...
public partial class ManualMusicVideoViewModel : ObservableObject
{
    ...
    [ObservableProperty] private ObservableCollection<ManualVideoResultViewModel> _manualItems;
    ...
    public ManualMusicVideoViewModel(Artist art)
    {
        ...
        ;
        ManualItems = new ObservableCollection<ManualVideoResultViewModel>();
    }
    ...
    {
        ManualItems.Remove((ManualVideoResultViewModel)sender);
    }
    ...
    public void AddSingleToList()
    {
        ...
        var newMvEntry = new ManualVideoResult(Title, Year, CoverUrl, id, CurrAlbum.Artist, CurrAlbum, _vidData);
        var mvVM = new ManualVideoResultViewModel(newMvEntry);
    ...
    public async Task<int> GenerateManualNFO(string vidPath, int currInd)
    {
        ...
        newMV.year = ManualItems[currInd].Album.Year;
        newMV.artist = Artist;
        ...
        if (ManualItems[currInd].so != null)
        {
