...
public partial class VideoResultsViewModel : ObservableObject
{
    ...
    public async static Task<VideoResultsViewModel?> CreateViewModel(SearchSource source, Artist artist,
        Album? album = null)
    {
        //First, we need to get a full list of videos from the artist
